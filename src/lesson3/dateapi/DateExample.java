...
public class DateExample {
	public static void main(String[] args) throws ParseException {
		...
		Date d1 = new Date(1425927919470l); // Mon Mar 09 14:05:19 CDT 2015
		//d = d1;
		...
		System.out.println("d.getTime() : " + d.getTime()); // returns how many
															// milliseconds have
															// passed since
															// January 1, 1970
		...
		SimpleDateFormat sdf1 = new SimpleDateFormat(); // 5/20/20, 11:30 AM
