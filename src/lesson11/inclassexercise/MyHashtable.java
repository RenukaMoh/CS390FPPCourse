...
public class MyHashtable implements Iterable {
	...
	//to create a collection framework using sets rather
	...
	/** returns iterator for the keys only -- best to change to Iterator or Entry objects */
